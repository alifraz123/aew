                                    ...
                                    <table class="table">
                                        ...
                                        <tbody id="whereProductsShow">
                                            ...
                                            <tr>
                                                ...
                                                <td><input type='number' name='Rate[]' class='form-control' value='{{$sbd->Rate}}'></td>
                                                <td><input type='text' name='Category[]' value='{{$sbd->Category}}' required class='form-control'></td>
                                                <td><input type='number' oninput="changeInvoice_oninput()" name='Quantity[]' value='{{$sbd->Quantity}}' required class='form-control'>
                                                <td><input type='number' name='productTotal[]' value='{{$sbd->Total}}' required class='form-control'>
                                        ...
                                        <div class="row">
                                            <div class="col-sm-6">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" value="{{$salebook->Rent}}" oninput="add_total_and_rent()" name="Rent" id="Rent" required class="form-control" placeholder="Enter Rent">
                                                </div>
                                            </div>
                                            <div class="col-sm-6">
                                                <div class="form-group">
